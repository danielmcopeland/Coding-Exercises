...
public class Main {
	...
	private static void simpleArrayList() {
		...
		String firstItem = (String)simpleArrayList.get(0); // Prints "Foo"
		System.out.printf("First item in simpleArrayList: %s%n", firstItem);
		System.out.println();
	}
	...
	private static void genericArrayList() {
		...
		int genericArraySize = genericArrayList.size();
		System.out.printf("Generic Array Size: %d%n", genericArraySize);
		System.out.println();
	}
